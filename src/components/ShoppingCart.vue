         ...
         <tr v-else v-for="(c, i) in cart" :key="i">
             ...
             <td>
              ...
              >
               ...
               @click="handleSubtrackProduct(c.product.id)"
               >
                -
               </button>
               <button class="btn small btn-danger mx-1"
                       @click="handleRemoveProuduct(c.product.id)"
               >
                      remove
               </button>               
             </td>
...
export default {
  ...
  methods: {
    ...mapMutations({
      ...
      subtrackProduct: "cart/subtrackProduct",
    ...
    ...mapActions({
      ...
      handleSubtrackProduct(id) {
            this.subtrackProduct(id);
      },
